...
public class ValidadorFecha {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Integer dia = (args.length > 0) ? Integer.parseInt(args[0]) : Integer.parseInt(sc.nextLine());

            System.out.println("Ingrese el mes");
            Integer mes = (args.length > 0) ? Integer.parseInt(args[1]) : Integer.parseInt(sc.nextLine());

            System.out.println("Ingrese el anio");
            Integer anio = (args.length > 0) ? Integer.parseInt(args[2]) : Integer.parseInt(sc.nextLine());
